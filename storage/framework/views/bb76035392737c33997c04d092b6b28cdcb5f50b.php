                    ...
                    <div class="col-12 col-lg-9 text-center">
                        <h2 class="h2 fw-700 pb-2">
                            ...
                            <span class="d-inline d-lg-inline-block position-relative blocosistemap"
                                ...
                                <?php echo e(__('texts.sistema_personalizado_mobile')); ?>

                            </span>
                            <span class="d-inline d-lg-inline-block position-relative blocosistemap"
                                id="annotate-sistema-pers_mobile3">
                                <?php echo e(__('texts.sistema_personalizado_mobile2')); ?>
                                        ...
                                        <div class="card-body">
                                            <div
                                                ...
                                                <img class="m-1 icon-card-vantagens-dark"
                                                    src="<?php echo e(asset('assets/icons/coffee-dark.svg')); ?>"
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                        <div class="card-body">
                                            <div
                                                class="rounded-4 bg-blue-light bg-blue-light-2 text-blue p-2 d-inline-block">
                                                <img src="<?php echo e(asset('assets/icons/eye.svg')); ?>" alt="Visão macro"
                                                    width="50" class="m-1 icon-card-vantagens">
                                                ...
                                                <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                                        <div class="card-body">
                                                            <div
                                                                class="rounded-4 bg-blue-light bg-blue-light-2 text-blue p-2 d-inline-block">
                                                                <img src="<?php echo e(asset('assets/icons/dollar-sign.svg')); ?>"
                                                    ...
                                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                                        <div class="card-body">
                                                            <div
                                                                class="rounded-4 bg-blue-light bg-blue-light-2 text-blue p-2 d-inline-block">
                                                                <img class="m-1 icon-card-vantagens"
                                                                    src="<?php echo e(asset('assets/icons/coffee.svg')); ?>"
                                                            ...
                                                            <h3 class="card-title h4 mt-3 fw-600">
                                                                <?php echo e(__('texts.poupe_tempo')); ?></h3>
                                                            <p class="card-text text-gray">
                                                                <?php echo e(__('texts.nao_perca_mais_tempo_escrevendo_relatorios_ou_fazendo_calculos_o_sistema_faz_isso_automaticamente')); ?>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                                        <div class="card-body">
                                                            <div
                                                                class="rounded-4 bg-blue-light bg-blue-light-2 text-blue p-2 d-inline-block">
                                                                <img src="<?php echo e(asset('assets/icons/trending-up.svg')); ?>"
                                                            ...
                                                            <h3 class="card-title h4 mt-3 fw-600">
                                                                <?php echo e(__('texts.otimize_vendas')); ?>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                                        <div class="card-body">
                                                            <div
                                                                class="rounded-4 bg-blue-light bg-blue-light-2 text-blue p-2 d-inline-block">
                                                                <img src="<?php echo e(asset('assets/icons/archive.svg')); ?>"
                                                            ...
                                                            <h3 class="card-title h4 mt-3 fw-600">
                                                                <?php echo e(__('texts.controle_recursos')); ?>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                                        <div class="card-body">
                                                            ...
                                                            <h3 class="card-title h4 mt-3 fw-600">
                                                                <?php echo e(__('texts.historico_salvo')); ?>
                                                ...
                                                <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="card border-0 rounded-4 card-vantagens h-100">
                                                        <div class="card-body">
                                                            <div
                                                                class="rounded-4 bg-blue-light bg-blue-light-2 text-blue p-2 d-inline-block">
                                                                <img src="<?php echo e(asset('assets/icons/eye.svg')); ?>"
                                                                    alt="Visão macro" width="50"
                                                                    class="m-1 icon-card-vantagens">
                                                                <img src="<?php echo e(asset('assets/icons/eye-dark.svg')); ?>"
                                                                    alt="Visão macro ícone" width="50"
                                                                    class="m-1 icon-card-vantagens-dark">
                                                            </div>
                                                            <h3 class="card-title h4 mt-3 fw-600">
                                                                <?php echo e(__('texts.visao_macro')); ?></h3>
                                                            <p class="card-text text-gray">
                                                                <?php echo e(__('texts.tenha_literalmente_os_olhos_em_cada_processo_da_sua_empresa_nao_deixe_mais_dinheiro_na_mesa')); ?>
                            ...
                            <div class="col-12 position-relative col-soluciona-2 ">
                                <div class="d-flex gap-3 flex-soluciona-2" id="flex-soluciona-2">
                                    <?php $__currentLoopData = [3, 3, 3]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/12.svg')); ?>"
                                                    class="w-100 logo-dark" alt="Id Pet">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/13.svg')); ?>"
                                                    class="w-100 logo-dark" alt="Jumbo">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/14.svg')); ?>"
                                                    class="w-100 logo-dark" alt="Ibrea">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/15.svg')); ?>"
                                                    class="w-100 logo-dark" alt="Pharma Liz">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/16.svg')); ?>"
                                                    class="w-100 logo-dark" alt="Dotting">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/17.svg')); ?>"
                                                    class="w-100 logo-dark" alt="New Music">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/18.svg')); ?>"
                                                    class="w-100 logo-dark" alt="Marcos Advocacia">
                                            </div>
                                        </div>
                                        <div class="card border-0 rounded-3 overflow-hidden card-soluciona">
                                            <div class="card-body p-0 d-flex p-3 px-4 align-items-center">
                                                <img src="<?php echo e(asset('assets/images/logos/19.svg')); ?>"
                            ...
                            <div class="col-12 col-12-depoimentos">
                                ...
                                <div class="glide mb-5">
                                    ...
                                    <div class="glide__arrows" data-glide-el="controls">
                                        <button class="glide__arrow glide__arrow--left p-0 border-0 shadow-none"
                                            data-glide-dir="<">
                                            <img src="<?php echo e(asset('assets/icons/arrow-left-circle.svg')); ?>"
    ...
    <section>
        <div class="py-5 pb-0">
            ...
            <div
                ...
                <div id="myVideo-2">
                    <img src="<?php echo e(asset('assets/images/bg-headera.gif')); ?>" alt="">
                </div>
                <!-- Conteúdo -->
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp644\www\Indutiva\lp-sistemas\resources\views/home.blade.php ENDPATH**/ ?>